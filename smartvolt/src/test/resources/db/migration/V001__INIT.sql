...
CREATE TABLE charging_station (
    ...
    CONSTRAINT fk_charging_station_operator FOREIGN KEY (operator_user_id) REFERENCES station_operator(user_id) ON DELETE CASCADE
);
...
CREATE TABLE booking (
    ...
    CONSTRAINT fk_booking_driver FOREIGN KEY (driver_user_id) REFERENCES ev_driver(user_id) ON DELETE CASCADE,
...
CREATE TABLE payment (
    ...
    driver_user_id BIGINT, -- ManyToOne relationship with EvDriver
    booking_id BIGINT UNIQUE, -- OneToOne relationship with Booking
    CONSTRAINT fk_payment_driver FOREIGN KEY (driver_user_id) REFERENCES ev_driver(user_id) ON DELETE CASCADE,
