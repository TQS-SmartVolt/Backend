package ua.tqs.smartvolt.smartvolt.integration_tests;
...
class ChargingStationControllerIntegrationTest {
  ...
  @Autowired private StationOperatorRepository stationOperatorRepository;
  ...
  void testCreateChargingStation_WhenOperatorExists_CreatesChargingStation() throws Exception {
    ...
    String requestBody =
        "{ \"name\": \"Station 1\", \"latitude\": 12.34, \"longitude\": 56.78, \"operatorId\": "
            + operator.getUserId()
            + " }";
    // When & Then
    mockMvc
